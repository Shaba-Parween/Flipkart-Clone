# Flipkart-Clone
**Flipkart Clone , A MERN stack app with styling using MaterialUI, for state handling using Redux , We can explore different products , with Buying and Add to cart functionality with Paytm Payment Gateway.**
